...
<!--  
	...
	따로 존재하기 때문에 세션은 웹브라우저와 관련된 정보를 저장하기에 사용한다.
	...
	3. getLastAccessedTime() : 웹브라우저가 마지막에 접근한 시간을 리턴
	...
	2. setMaxInactiveInterval() 메서드 사용 (초단위)
...
-->
<%@page session="true" %> <!-- JSP에서 세션을 생성여부 -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
