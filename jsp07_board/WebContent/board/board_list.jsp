...
<body>
	...
	<div class="container mt-dm-5" align="center">
		<div class="jumbotron">
			<h3>게시글목록보기</h3>
		...
		<form action="boardList.do" class="form-line">
			<div class="input-group">
				...
				<a href="boardWriteForm.do?p=${param.p}" class="btn btn-success col-sm-1">글쓰기</a>
			</div>
		</form>
		<br class="mt-sm-5" />
			...
			<c:forEach var="board" items="${ boardList }">
				<tr>
					...
					<td>
						...
						<a href="boardDetail.do?bno=${ board.getBno() }"> ${ board.getSubject() }</a>
						<span class="badge badge-danger ml-em-3"> ${ board.getReadcount() }</span>					
					</td>
					...
					<td align="center">
						<a href="boardDeleteForm.do?bno=${ board.getBno() }">
...
<%-- 	<c:set var="startPage" value="${ param.p }" />
	<c:set var="endPage" value="${ param.p + 10 }" />
	<c:set var="totalPage" value="11" /> --%>
	...
	<div class="container" align="center">
		<ul class="pagination justify-content-center">
			...
			<c:forEach var="page_num" begin="${ pageInfo.getStartPage() }" end="${ pageInfo.getEndPage() }">
				<li class="page-item page-link"><a href="boardList.do?p=${ page_num }">${ page_num }</a></li>
			</c:forEach>
