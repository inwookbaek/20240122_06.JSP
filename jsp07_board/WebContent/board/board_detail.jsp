...
<body>
	<div class="container" align="center">
		...
		<div class="form-group input-group">
			<a href="boardModifyForm.do?bno=${param.bno}" class="btn btn-success mr-sm-3">수정</a>
			<a href="boardDeleteForm.do?bno=${param.bno}" class="btn btn-success mr-sm-3">삭제</a>
			<a href="boardReplyForm.do?bno=${param.bno}" class="btn btn-success mr-sm-3">답변</a>
			<a href="boardList.do" class="btn btn-success mr-sm-3">글목록</a>
		</div>
	</div>
</body>
</html>